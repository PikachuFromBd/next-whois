...
import { listHistory, removeHistory, searchHistory } from "@/lib/history";
...
export default function Home() {
  ...
  return (
    <ScrollArea className="w-full h-[calc(100vh-4rem)]">
      <main
        className={
          "w-full min-h-[calc(100vh-4rem)] grid place-items-center p-4 md:p-6 relative overflow-hidden"
        }
      >
        <div
          className={"flex flex-col items-center w-full h-fit max-w-[640px]"}
        >
          <motion.div
